...
# this filter sout all RF events
  ...
  #  this. It's a bit convoluted since you have to do the indexing yourself (we
...
## HACK HACK HACK to workaround ROOT 6.22 bad pythonization of multidimensional arrays. 
