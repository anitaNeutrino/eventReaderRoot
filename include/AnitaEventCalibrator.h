...
class AnitaEventCalibrator : public TObject
{
  ...
  Double_t relativeCableDelays[NUM_SURF][NUM_CHAN][NUM_CHIP]; ///< From AMPA inputs to digizier delays
  Double_t relativePhaseCenterToAmpaDelays[NUM_SURF][NUM_CHAN]; ///< From phase center to AMPAs (hopefully)
